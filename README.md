...
## Instruction for Installation
To install the Cometale as an interactive projection, you need the following materials: </br>
<div>
  <ul>
    <li>a computer</li>
    <li>a Kinect</li>
...
To achieve the optimal viewing experience, you may consider set up this projection in a dark or dimmed room of at least 6m x 5m in size. </br>
<div align="center">
  <img src="./images/installation_guide.png" width="80%" text-align="center" alt="installation_guide.png">
</div>

### Get the TouchDesigner program running with Kinect
...
Please also read and follow the instructions in all the text Opeartors in pink color. 

### Set up the interactive projection
